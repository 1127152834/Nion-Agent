"""File conversion helpers shared across gateway and harness.

This module intentionally has no FastAPI / gateway dependencies so harness-layer code
can reuse the same conversion logic without importing app-layer routers.
"""
