...
_EXPORT_MAP: dict[str, tuple[str, str]] = {
    ...
    "send_a2ui_json_to_client_tool": (".a2ui_tool", "send_a2ui_json_to_client_tool"),
    ...
    "ovfs_find_tool": (".openviking_fs_tools", "ovfs_find_tool"),
    "ovfs_search_tool": (".openviking_fs_tools", "ovfs_search_tool"),
    "ovfs_overview_tool": (".openviking_fs_tools", "ovfs_overview_tool"),
    "ovfs_read_tool": (".openviking_fs_tools", "ovfs_read_tool"),
    "ovfs_ls_tool": (".openviking_fs_tools", "ovfs_ls_tool"),
    "ovfs_tree_tool": (".openviking_fs_tools", "ovfs_tree_tool"),
    "ovfs_grep_tool": (".openviking_fs_tools", "ovfs_grep_tool"),
    "ovfs_glob_tool": (".openviking_fs_tools", "ovfs_glob_tool"),
    "ovfs_stat_tool": (".openviking_fs_tools", "ovfs_stat_tool"),
    "nion_manage_tool": (".system_manage_tools", "nion_manage_tool"),
