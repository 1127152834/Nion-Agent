"""Skill validation helpers shared across harness and gateway.

This module intentionally has no FastAPI / gateway dependencies so that harness-layer
code (e.g. client, tools) can validate skills without importing app-layer modules.
"""
