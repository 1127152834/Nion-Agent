...
export function ModelsSection({
  ...
  const m = t.migration.settings?.configSections?.models;
      ...
      return (
        <section className="space-y-4 rounded-xl border bg-card p-4">
          ...
          <div className="flex items-center justify-between gap-2">
            ...
            <Badge variant="outline">{protocolLabel(protocol, copy)}</Badge>
          </div>
              ...
              >
                <div className="min-w-0 flex-1 space-y-1">
                  ...
                  <div className="text-muted-foreground flex items-center gap-2 text-xs">
                    ...
                    <span>·</span>
                    <span>{boundProtocol ? protocolLabel(boundProtocol, copy) : copy.unassigned}</span>
                  </div>
                </div>
    ...
    return (
      <section className="space-y-4 rounded-xl border bg-card p-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Badge variant="outline">
            {copy.providerProtocol}: {boundProtocol ? protocolLabel(boundProtocol, copy) : copy.unassigned}
          </Badge>
        </div>
