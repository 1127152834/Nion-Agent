    ...
    return (
      <div className="space-y-3">
        {models.map((model) => {
          ...
          const canDownload = Boolean(desktopBridge?.downloadRetrievalModel);
          const canImport = Boolean(desktopBridge?.importRetrievalModel);
          const canRemove = Boolean(desktopBridge?.removeRetrievalModel);
