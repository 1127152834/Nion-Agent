  ...
  return (
      ...
      >
        <SwitchPrimitive.Thumb
          ...
          className={cn(
            "pointer-events-none block size-5 rounded-full bg-primary shadow-[0_1px_2px_hsl(var(--foreground)/0.12),0_8px_18px_-12px_hsl(var(--foreground)/0.45)] ring-0 transition-[transform,background-color] duration-200 data-[state=checked]:translate-x-4 data-[state=checked]:bg-primary-foreground data-[state=unchecked]:translate-x-0"
          )}
        />
      </SwitchPrimitive.Root>
  )
